...
/// Matches inbound Maxio requests by method and/or a path fragment (the upstream wire path, which
/// the gate knows for each op), and applies <see cref="Action"/> to the first <see cref="Times"/>
